...
![인터뷰 영상 캡처. 빈 강당 객석을 배경으로 안경을 쓴 남성이 이야기하고 있고, 화면 왼쪽 아래에 '강대현 / 넥슨코리아 COO' 자막이 떠 있다.](/images/retro-2022/01-2022-12-26-------1.18.30.png)
...
!['Nexon'이라고 손글씨로 적힌 흰 안전모를 쓰고 엄지를 치켜든 개구리 페페 밈.](/images/retro-2022/02-IMG_0292.png)
...
![비대면 강연 현장 사진. 스크린에 '블록체인 엔터테인먼트 서비스 기획과 개발'이라는 발표 표지가 띄워져 있고, 오른쪽 작은 창에 화상으로 연결된 내 얼굴이 보인다. 앞쪽에는 청중의 뒷모습이 있다.](/images/retro-2022/03-2022-12-26-------1.13.23.png)
...
![사내에 공유한 '2021 Intelligence Labs NFT' 문서 캡처. NFT를 알게 됐을 때 겪은 '1단계 부정 / 2단계 긍정(NFT FOMO)' 심리를 적고, 동료들에게 의미 있는 선물을 하고 싶어 도트 찍기와 NFT 발행에 도전하게 되었다는 배경, 그리고 '2. 이미지 만들기' 절의 손그림 습작들이 이어진다.](/images/retro-2022/04-2022-12-26-------1.14.23.png)

![직접 찍은 도트 캐릭터 NFT 네 개. 흰 얼굴에 노란 머리·민트색 머리·검은 양갈래 머리를 한 캐릭터들이 각각 무지개 옷, 파란 정장에 빨간 망토, 보라색 옷, 회색 정장을 입고 있고 오른쪽 아래에 '21'이 찍혀 있다.](/images/retro-2022/05-2022-12-26-------1.14.31.png)
...
!['나는 Project A에서 왜 블록체인을 하려고 하는가?' 문서 캡처. 블록체인의 본질을 'trustless 시스템을 만든다'로 정리하고, 아래 도식에서 기존 서비스는 데이터 공개·데이터 신뢰·소유권 변화라는 n번의 개선을 거쳐, 신규 서비스는 블록체인이라는 혁신을 거쳐 '차세대 서비스'로 이어진다고 그려 두었다.](/images/retro-2022/06-2022-12-26-------1.38.14.png)
