...
![입사 2일차에 쓴 설득 문서 캡처. "React가 대세입니다. 바꾸시죠!" 같은 글이 절대 아니라 "이렇게도 해볼 수 있을 것 같네요"라는 제안이라는 머리말 아래, 목차가 '1. Vue VS React - 커뮤니티(설치 수·채용 시장 인재 검색·개발자 커뮤니티)', '2. 코드는 어떻게 변경 될까?(Component Structure, PX Project 컴포넌트 변경)', '3. 어떤식으로 바꾸면 좋을까?(Atomic Design, StoryBook)', '4. 그 외 논의 되면 좋을 것'으로 이어진다.](/images/retro-first-solo-web-project/01-2020-09-28-------11.25.30.png)
...
![매일 쓴 Daily 문서 목록. #167부터 #133까지 역순으로 쌓여 있고, 각 줄마다 그날 날씨 이모지와 'Daily', '35주차' 같은 주차 태그, 작성 날짜가 붙어 있다.](/images/retro-first-solo-web-project/02-2020-09-28-------11.41.32.png)
...
!['FrontEnd 작업 업데이트 내역' 문서 캡처(세부 내용은 흐리게 처리됨). 머지 시점별로 1~5번 항목이 나뉘고, 각 항목 아래에 Routing·페이지네이션 같은 하위 작업과 'TO DO', '버그 제보' 블록이 반복해서 붙어 있다.](/images/retro-first-solo-web-project/03-2020-09-28------1.32.46.png)
...
!["ME TRYING TO UNDERSTAND CODE I WROTE ONE WEEK EARLIER"라고 적힌 밈. 졸라맨이 잔뜩 찌푸린 얼굴로 모니터를 노려보고 있다.](/images/retro-first-solo-web-project/04-2f871d301884c8.jpg)
...
![유비(劉備)를 그린 동양화 초상. 관을 쓰고 두 손을 모은 채 정면을 보고 있다.](/images/retro-first-solo-web-project/05-img.jpeg)
...
![컴포넌트 트리 다이어그램. &lt;App /&gt;에서 &lt;Page /&gt;, &lt;ItemList /&gt;, &lt;GameItem /&gt;으로 한 단계씩 내려가고 마지막에 &lt;Input /&gt; 두 개로 갈라진다.](/images/retro-first-solo-web-project/06-img.png)
...
![졸라맨이 화면을 손가락질하며 못마땅한 표정으로 "아무리 봐도 '스파게티'코드 이군요"라고 말하는 짤.](/images/retro-first-solo-web-project/07-images.jpeg)
...
!['기혁 Page' 한 장의 의존 관계 다이어그램. 위쪽 회색 상자에 GameStore·UserStore·기혁Store가, 아래쪽 초록 상자에 A Button·B Button·C List·D Div가 놓여 있고, 그 사이를 화살표들이 이리저리 교차하며 얽혀 있다.](/images/retro-first-solo-web-project/08-1.png)
