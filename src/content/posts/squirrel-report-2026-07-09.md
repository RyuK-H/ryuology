...
description: "오픈 3일차, 주요 AI 크롤러가 총출동했다. 그리고 ChatGPT-User를 사칭한 가짜 손님을 IP 추적으로 걸러냈다. User-Agent는 자기신고일 뿐이라는 것을 배운 날의 관측 보고서."
...
- 오픈 3일차, 주요 AI 수집기가 사실상 **총출동**했습니다 — Anthropic, Google, xAI, Apple, Bing, Common Crawl까지
...
문패를 단 지 사흘 만에, 이 작은 블로그를 학습 재료 후보로 실어 나르는 트럭이 일곱 회사에서 왔습니다.
