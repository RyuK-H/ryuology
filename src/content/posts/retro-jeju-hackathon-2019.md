...
![JEJU BLOCKCHAIN HACKATHON 2019 네온사인과 귤이 달린 초록 벽 앞에서, 회색 후드를 입고 '최우수상 200만원'이라고 적힌 빨간 상패를 들고 서 있는 나.](/images/retro-jeju-hackathon-2019/01-2019-11-10------4.08.02.png)
...
![솔리디티 코드 스크린샷. AnimalData 구조체(동물 등록 번호·이름·품종·털색·성별·생년월일·취득일·특이사항)를 정의하고, 그 아래 mapName·mapAnimalType·mapColor 등 항목별 mapping을 uint256 배열 인덱스로 선언해 두었다.](/images/retro-jeju-hackathon-2019/02-2019-11-10------5.10.34.png)
...
![줄노트에 손글씨로 쓴 쪽지. "너무 고마워서 뭐라고 해야할지 키보르로 표현할 수 없어서 줄로 씁니다 고마워요"라고 적혀 있다.](/images/retro-jeju-hackathon-2019/03-2019-11-10------5.23.38.png)
...
!['반려견 등록' 화면 1단계. 반려견 이름, 품종, 모색, 성별(수컷·암컷), 중성화 수술 여부를 차례로 입력받는 폼이다.](/images/retro-jeju-hackathon-2019/04-img.png)

!['반려견 등록' 화면 2단계. 입양일·생년월일을 입력받고, 병력을 슬개골·결석·습진·눈물자국·각막손상·기관지협착증·발작·피부질환 태그로 고를 수 있게 되어 있다.](/images/retro-jeju-hackathon-2019/05-img.png)
